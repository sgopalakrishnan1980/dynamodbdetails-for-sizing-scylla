...
# ============================================================================
# DynamoDB Metrics Collection Script (Linux Version)
...
main() {
    ...
    local start_time=$(date -u -d "20 minutes ago" +"%Y-%m-%dT%H:%M:%SZ")
    ...
    for table_info in "${tables_with_regions[@]}"; do
        ...
        while [ $iteration -le $max_iterations ]; do
            ...
            start_time=$(date -u -d "$start_time - 20 minutes" +"%Y-%m-%dT%H:%M:%SZ")
